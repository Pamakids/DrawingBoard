...
final internal class AnimeManager implements IProcess
{
	
	final agony_internal function get numAnimators() : int
	{
	 ...
	 */
	final agony_internal function addAnime( A:Animator ) : Boolean
	{
	 ...
	 *  @param	A
	 */
	final agony_internal function removeAnime( A:Animator ) : void
	{
		var index:int
	...
	internal var m_runningList:Vector.<Animator> = new <Animator>[]
	internal var m_runningLength:int;
	internal var m_joiningList:Vector.<Animator> = new <Animator>[]
