...
final public class MovieClipSection extends Section
{
	...
	final override agony_internal function parseAssets( assetRef:*, tx:Number, ty:Number ) : void
	{
		var def:Class
	...
	final override agony_internal function doesPointerNull( pointer:int ) : Boolean
	{
		m_swf.gotoAndStop(pointer);
