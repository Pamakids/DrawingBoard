package org.agony2d.view.core
{
	...
	public interface IModule extends INotifier
	{
		...
		function init(layer:int=-1, stateArgs:Array=null, delayedForEnter:Boolean=true, delayedForRender:Boolean=true, gapX:Number=NaN, gapY:Number=NaN, horizLayout:int=1, vertiLayout:int=1):void

		function exit():void

		function get spParent():Sprite
	}
}
