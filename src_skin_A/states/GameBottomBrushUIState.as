package states
{
	...
	public class GameBottomBrushUIState extends UIState
	{
		override public function enter():void
		{
			...
			mBrushCoordsA=[new Point(91, GAP_Y), new Point(167, GAP_Y - 4), new Point(269, GAP_Y + 1), new Point(354, GAP_Y - 14), new Point(425, GAP_Y + 8), new Point(506, GAP_Y + 14)]

			brushIcons=[GameAssets.img_brush_waterColor, GameAssets.img_brush_pencil, GameAssets.img_brush_crayon, GameAssets.img_brush_pink, GameAssets.img_brush_maker, GameAssets.img_brush_eraser]
...
//		private var mBrushScaleSlider:Slider
		...
		private function onSelectBrush(e:AEvent):void
		{
			...
			UserBehaviorAnalysis.trackEvent('C', '021', index.toString(), index);
...
//		}
		...
		private function onSelectColor(e:AEvent):void
		{
			...
			UserBehaviorAnalysis.trackEvent('C', '022', color + '', color);
		}
