...
//			}
		...
		{
			super.exit();
			UserBehaviorAnalysis.trackTime('F', exsitTime, '停留');
			if (recordTime)
				UserBehaviorAnalysis.trackTime('F', recordTime, '录音');
...
//			trace("start...")
			...
			UserBehaviorAnalysis.trackEvent('F', '120');
		}

		private function onStopRecord(e:AEvent):void
		{
			recordTime=getTimer() - recordTime;
//			if(mTime > 2000){
